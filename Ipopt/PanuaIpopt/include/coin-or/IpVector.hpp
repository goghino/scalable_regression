...
public:
   ...
   /** Element-wise applicatin of function func to the entries in the
       vector */
   inline void ElementWiseFunc(Number (*func)(Number));
...
protected:
   ...
   /** Replaces entries with log of the entry */
   virtual void ElementWiseFuncImpl(Number (*func)(Number)) = 0;
...
inline void Vector::ElementWiseFunc(Number (*func)(Number))
{
   ElementWiseFuncImpl(func);
   ObjectChanged();
}
